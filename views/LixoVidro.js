...
export default function LixoVidro(props)
{
    return(
        ...
        <TouchableOpacity><Image source={require('../assets/img/vidro.png')} /></TouchableOpacity>
         </View>
         <View>
             <Text style={styles.text_about}>
             Um futuro com embalagens de vidro retornáveis tem de ser a
                  ossa meta, pois evita o custo de reciclá-lo.</Text></View>
                  <View><Text style={styles.text_about}>Até lá, reutilize ao máximo
                  ...
                  múltiplos cacos de vidro) ainda é complexo e caro.</Text></View>
         </View>
